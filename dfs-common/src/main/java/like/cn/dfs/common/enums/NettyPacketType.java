...
public enum NettyPacketType {
    ...
    FETCH_BACKUP_NODE_INFO(14, "客户端或者DataNode往NameNode上发起请求获取BackupNode信息"),
    ...
    public static NettyPacketType getEnum(int value) {
        for (NettyPacketType packetType : values()) {
